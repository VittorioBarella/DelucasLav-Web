                  ...
                  <div class="col-md-12">
                     <div class="configdiv">
                        ...
                        <form method="POST" action="cadastra-cliente.php">
                           <input type="text" name="nomeCliente" placeholder="Digite o nome do cliente" class="form-control"><br>
                           <input type="text" name="telefone" placeholder="Digite o telefone do cliente" class="form-control"><br>
                           <input type="text" name="endereco" placeholder="Digite o endereço do cliente" class="form-control"><br>
                           <input type="text" name="email" placeholder="Digite o e-mail do cliente" class="form-control"><br>
